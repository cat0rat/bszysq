...
<head>
	...
	<script type="text/javascript" src="/admin/style/js/smscode.js?r=${__rnd}"></script>
</head>
<body>
	...
	<form id="search_form" >
		<div class="l_search_tr">
			<div class="l_search_td">
				手机号：<input type="text" name="name" class="x_input"/>
			</div>
			<div class="l_search_td">
				<select name="typen" class="easyui-combobox x_input x-ipt3" 
...
<div id="lookMgrDlg" style="padding-left:5px;">
	...
	<table class="dlg-tb">
		<tr><td class="t-l">手机号：</td>
			<td class="t-l-c" colspan="3">
				<input type="text" name="mobile" class="x_input x-ipt3" value="" />
			</td></tr>
		<tr><td class="t-l">验证码：</td>
			<td class="t-l-c" colspan="3">
				<input type="text" name="code" class="x_input x-ipt3" />
			</td></tr>
		<tr><td class="t-l">类型：</td>
			<td class="t-l-c" colspan="3">
				<select name="typen" class="easyui-combobox x_input x-ipt3" 
					data-options="panelHeight:'auto',editable:false, width: 150"> 
					<option value="0">注册</option>   
