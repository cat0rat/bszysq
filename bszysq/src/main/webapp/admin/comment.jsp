...
<div id="lookMgrDlg" style="padding-left:5px;">
	...
	<table class="dlg-tb">
		...
		<tr><td class="t-l">评论者：</td>
			<td class="t-l-c" colspan="3">
				<input type="text" name="usernname" class="x_input x-ipt3" value="" />
			</td></tr>
		<tr><td class="t-l">对谁的评论：</td>
			<td class="t-l-c" colspan="3">
				<input type="text" name="tousernname" class="x_input x-ipt3" value="" />
			</td></tr>
